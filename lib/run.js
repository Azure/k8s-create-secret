...
function getGenericSecretArguments(secretName) {
    ...
    args.push(...(0, toolrunner_1.argStringToArray)(parsedArgument));
    return args;
}
/**
...
function run2() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const stringData = JSON.parse(core.getInput('string-data')) || {};
        ...
        const resp = yield api.createNamespacedSecret(namespace, secret);
        console.log(resp);
        return;
    });
}
